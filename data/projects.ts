...
export const projects: Project[] = [
  ...
  },
  {
    ...
    iconName: "Waves",
    title: "FlowCore",
    tagline: "Ingeniería de infraestructura — 100% offline, 121 requerimientos",
    description:
      "Simulador de redes de alcantarillado sanitario y pluvial. Genera series temporales de nivel y caudal, aplica pipeline de limpieza de datos y calcula caudal con la ecuación de Manning. Corre completamente offline.",
    stack: ["Python 3.10+", "SQLite (WAL)", "HTML", "JavaScript"],
    highlights: [
      "121 requerimientos documentados formalmente",
      "Pipeline de limpieza: filtro mediana + z-score + tasa de cambio",
      "Ecuación de Manning en 3 geometrías (rect/circular/trapezoidal)",
      "100% offline, sin dependencias de terceros después de instalación",
    ],
